...
console.log(month[7],  month[10], month[0]);
...
var elements1 = [5, 15, -5, 20, 12, 18, 72, 14, 9];
console.log(elements1[0],  elements1[3], elements1[6]);
...
var elements2 = [[1, 2, 1, 24], [8, 11, 9, 4], [7, 0, 7, 27], [7, 4, 28, 14], [3, 10, 26, 7]];
console.log(elements2[0][3]);
console.log(elements2[2]);
console.log(elements2[2][1]);
